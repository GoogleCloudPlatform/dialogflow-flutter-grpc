...
class TestImportEnumMap extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.int, $9.ImportEnumForMap>(
        ...
        keyFieldType: $pb.PbFieldType.O3,
        valueFieldType: $pb.PbFieldType.OE,
        valueOf: $9.ImportEnumForMap.valueOf,
        enumValues: $9.ImportEnumForMap.values,
        packageName: const $pb.PackageName('protobuf_unittest'))
    ..hasRequiredFields = false;

  TestImportEnumMap._() : super();
  factory TestImportEnumMap({
    $core.Map<$core.int, $9.ImportEnumForMap>? importEnumAmp,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.int, $9.ImportEnumForMap> get importEnumAmp => $_getMap(0);
}
