...
import 'unittest_lite.pb.dart' as $8;
...
class TestMapLite extends $pb.GeneratedMessage {
  ...
  factory TestMapLite({
    ...
    $core.Map<$core.int, $8.ForeignMessageLite>? mapInt32ForeignMessage,
  ...
  @$pb.TagNumber(17)
  $core.Map<$core.int, $8.ForeignMessageLite> get mapInt32ForeignMessage =>
      $_getMap(16);
...
class TestMessageMapLite extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.int, $8.TestAllTypesLite>(
        ...
        keyFieldType: $pb.PbFieldType.O3,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: $8.TestAllTypesLite.create,
        packageName: const $pb.PackageName('protobuf_unittest'))
    ..hasRequiredFields = false;

  TestMessageMapLite._() : super();
  factory TestMessageMapLite({
    $core.Map<$core.int, $8.TestAllTypesLite>? mapInt32Message,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.int, $8.TestAllTypesLite> get mapInt32Message => $_getMap(0);
}
