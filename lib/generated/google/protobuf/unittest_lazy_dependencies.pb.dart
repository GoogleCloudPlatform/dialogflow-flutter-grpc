...
import 'unittest_lazy_dependencies_custom_option.pb.dart' as $19;
...
class ImportedMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$19.LazyMessage>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'lazyMessage',
        subBuilder: $19.LazyMessage.create)
    ..hasRequiredFields = false;

  ImportedMessage._() : super();
  factory ImportedMessage({
    $19.LazyMessage? lazyMessage,
  }) {
  ...
  @$pb.TagNumber(1)
  $19.LazyMessage get lazyMessage => $_getN(0);
  @$pb.TagNumber(1)
  set lazyMessage($19.LazyMessage v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $19.LazyMessage ensureLazyMessage() => $_ensure(0);
}
