...
class TestMap extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestMap',
    ...
    ..m<$core.int, $0.ForeignMessage>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mapInt32ForeignMessage', entryClassName: 'TestMap.MapInt32ForeignMessageEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.ForeignMessage.create, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.String, $0.ForeignMessage>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mapStringForeignMessage', entryClassName: 'TestMap.MapStringForeignMessageEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.ForeignMessage.create, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $0.TestAllTypes>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mapInt32AllTypes', entryClassName: 'TestMap.MapInt32AllTypesEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.TestAllTypes.create, packageName: const $pb.PackageName('protobuf_unittest'))
  ...
  factory TestMap({
    ...
    $core.Map<$core.int, $0.ForeignMessage>? mapInt32ForeignMessage,
    $core.Map<$core.String, $0.ForeignMessage>? mapStringForeignMessage,
    $core.Map<$core.int, $0.TestAllTypes>? mapInt32AllTypes,
  }) {
  ...
  @$pb.TagNumber(17)
  $core.Map<$core.int, $0.ForeignMessage> get mapInt32ForeignMessage =>
      $_getMap(16);

  @$pb.TagNumber(18)
  $core.Map<$core.String, $0.ForeignMessage> get mapStringForeignMessage =>
      $_getMap(17);

  @$pb.TagNumber(19)
  $core.Map<$core.int, $0.TestAllTypes> get mapInt32AllTypes => $_getMap(18);
}
...
class TestMessageMap extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.int, $0.TestAllTypes>(
        ...
        valueCreator: $0.TestAllTypes.create,
        packageName: const $pb.PackageName('protobuf_unittest'))
    ..hasRequiredFields = false;

  TestMessageMap._() : super();
  factory TestMessageMap({
    $core.Map<$core.int, $0.TestAllTypes>? mapInt32Message,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.int, $0.TestAllTypes> get mapInt32Message => $_getMap(0);
}
...
class TestRequiredMessageMap extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.int, $0.TestRequired>(
        ...
        keyFieldType: $pb.PbFieldType.O3,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: $0.TestRequired.create,
        packageName: const $pb.PackageName('protobuf_unittest'));

  TestRequiredMessageMap._() : super();
  factory TestRequiredMessageMap({
    $core.Map<$core.int, $0.TestRequired>? mapField,
  }) {
    final _result = create();
    if (mapField != null) {
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.int, $0.TestRequired> get mapField => $_getMap(0);
}
