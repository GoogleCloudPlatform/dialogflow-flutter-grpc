...
import 'unittest_optimize_for.pb.dart' as $17;
...
class TestEmbedOptimizedForSize extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$17.TestOptimizedForSize>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optionalMessage',
        subBuilder: $17.TestOptimizedForSize.create)
    ..pc<$17.TestOptimizedForSize>(
        2,
  ...
  factory TestEmbedOptimizedForSize({
    $17.TestOptimizedForSize? optionalMessage,
    $core.Iterable<$17.TestOptimizedForSize>? repeatedMessage,
  }) {
  ...
  @$pb.TagNumber(1)
  $17.TestOptimizedForSize get optionalMessage => $_getN(0);
  @$pb.TagNumber(1)
  set optionalMessage($17.TestOptimizedForSize v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $17.TestOptimizedForSize ensureOptionalMessage() => $_ensure(0);

  @$pb.TagNumber(2)
  $core.List<$17.TestOptimizedForSize> get repeatedMessage => $_getList(1);
}
