...
import 'unittest_lazy_dependencies_enum.pbenum.dart' as $18;
...
class Unittest_lazy_dependencies_custom_option {
  static final lazyEnumOption = $pb.Extension<$18.LazyEnum>(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
      ...
      138596335,
      $pb.PbFieldType.OE,
      defaultOrMaker: $18.LazyEnum.LAZY_ENUM_1,
      valueOf: $18.LazyEnum.valueOf,
      enumValues: $18.LazyEnum.values);
