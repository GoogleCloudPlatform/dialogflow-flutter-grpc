...
class TestAllTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.TestAllTypes>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optionalProto2Message', subBuilder: $0.TestAllTypes.create)
    ...
    ..pc<$0.TestAllTypes>(50, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repeatedProto2Message', $pb.PbFieldType.PM, subBuilder: $0.TestAllTypes.create)
  ...
  @$pb.TagNumber(20)
  $0.TestAllTypes get optionalProto2Message => $_getN(17);
  @$pb.TagNumber(20)
  set optionalProto2Message($0.TestAllTypes v) {
    setField(20, v);
  }
  ...
  @$pb.TagNumber(20)
  $0.TestAllTypes ensureOptionalProto2Message() => $_ensure(17);
  ...
  @$pb.TagNumber(50)
  $core.List<$0.TestAllTypes> get repeatedProto2Message => $_getList(40);
...
class TestProto2Required extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.TestRequired>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'proto2',
        subBuilder: $0.TestRequired.create);

  TestProto2Required._() : super();
  factory TestProto2Required({
    $0.TestRequired? proto2,
  }) {
    final _result = create();
    if (proto2 != null) {
  ...
  @$pb.TagNumber(1)
  $0.TestRequired get proto2 => $_getN(0);
  @$pb.TagNumber(1)
  set proto2($0.TestRequired v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $0.TestRequired ensureProto2() => $_ensure(0);
}
