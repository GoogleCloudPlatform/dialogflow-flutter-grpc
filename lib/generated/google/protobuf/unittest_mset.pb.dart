...
import 'unittest_mset_wire_format.pb.dart' as $20;
...
class TestMessageSetContainer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$20.TestMessageSet>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'messageSet',
        subBuilder: $20.TestMessageSet.create);

  TestMessageSetContainer._() : super();
  factory TestMessageSetContainer({
    $20.TestMessageSet? messageSet,
  }) {
  ...
  @$pb.TagNumber(1)
  $20.TestMessageSet get messageSet => $_getN(0);
  @$pb.TagNumber(1)
  set messageSet($20.TestMessageSet v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $20.TestMessageSet ensureMessageSet() => $_ensure(0);
}
...
class TestMessageSetExtension1 extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(16)
  $20.TestMessageSet get recursive => $_getN(1);
  @$pb.TagNumber(16)
  set recursive($20.TestMessageSet v) {
    setField(16, v);
  }
  ...
  @$pb.TagNumber(16)
  $20.TestMessageSet ensureRecursive() => $_ensure(1);
