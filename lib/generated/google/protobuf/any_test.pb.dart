...
class TestAny extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'int32Value',
        $pb.PbFieldType.O3)
    ..aOM<$3.Any>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'anyValue',
  ...
  factory TestAny({
    $core.int? int32Value,
    $3.Any? anyValue,
    $core.Iterable<$3.Any>? repeatedAnyValue,
    $core.String? text,
  }) {
  ...
  @$pb.TagNumber(2)
  $3.Any get anyValue => $_getN(1);
  @$pb.TagNumber(2)
  set anyValue($3.Any v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $3.Any ensureAnyValue() => $_ensure(1);

  @$pb.TagNumber(3)
  $core.List<$3.Any> get repeatedAnyValue => $_getList(2);
