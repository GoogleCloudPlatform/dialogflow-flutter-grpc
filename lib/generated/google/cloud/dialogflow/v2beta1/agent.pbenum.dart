...
class Agent_MatchMode extends $pb.ProtobufEnum {
  static const Agent_MatchMode MATCH_MODE_UNSPECIFIED = Agent_MatchMode._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MATCH_MODE_UNSPECIFIED');
  static const Agent_MatchMode MATCH_MODE_HYBRID = Agent_MatchMode._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MATCH_MODE_HYBRID');
...
class Agent_ApiVersion extends $pb.ProtobufEnum {
  static const Agent_ApiVersion API_VERSION_UNSPECIFIED = Agent_ApiVersion._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'API_VERSION_UNSPECIFIED');
  static const Agent_ApiVersion API_VERSION_V1 = Agent_ApiVersion._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'API_VERSION_V1');
  static const Agent_ApiVersion API_VERSION_V2 = Agent_ApiVersion._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'API_VERSION_V2');
  static const Agent_ApiVersion API_VERSION_V2_BETA_1 = Agent_ApiVersion._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
...
class Agent_Tier extends $pb.ProtobufEnum {
  static const Agent_Tier TIER_UNSPECIFIED = Agent_Tier._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TIER_UNSPECIFIED');
  static const Agent_Tier TIER_STANDARD = Agent_Tier._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TIER_STANDARD');
  static const Agent_Tier TIER_ENTERPRISE = Agent_Tier._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TIER_ENTERPRISE');
  static const Agent_Tier TIER_ENTERPRISE_PLUS = Agent_Tier._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
