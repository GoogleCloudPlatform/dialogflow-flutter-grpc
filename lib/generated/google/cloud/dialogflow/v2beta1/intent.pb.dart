  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'value')
    ..aOS(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultValue')
...
class Intent_Message_RbmCarouselCard extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Intent_Message_RbmCarouselCard_CardWidth>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cardWidth', $pb.PbFieldType.OE,
        defaultOrMaker:
    ...
    ..pc<Intent_Message_RbmCardContent>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cardContents',
        $pb.PbFieldType.PM,
...
class Intent_Message_RbmStandaloneCard extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Intent_Message_RbmStandaloneCard_CardOrientation>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cardOrientation', $pb.PbFieldType.OE,
    ...
    ..e<Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thumbnailImageAlignment', $pb.PbFieldType.OE,
        defaultOrMaker: Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment.THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED,
        valueOf: Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment.valueOf,
        enumValues: Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment.values)
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Intent_Message_RbmCardContent_RbmMedia_Height>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'height',
        $pb.PbFieldType.OE,
        defaultOrMaker: Intent_Message_RbmCardContent_RbmMedia_Height.HEIGHT_UNSPECIFIED,
...
class Intent_Message_RbmCardContent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Intent_Message_RbmCardContent_RbmMedia>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'media',
        subBuilder: Intent_Message_RbmCardContent_RbmMedia.create)
    ..pc<Intent_Message_RbmSuggestion>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestions', $pb.PbFieldType.PM,
        subBuilder: Intent_Message_RbmSuggestion.create)
    ..hasRequiredFields = false;
...
class Intent_Message_RbmSuggestion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Intent_Message_RbmSuggestedReply>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reply',
...
class Intent_Message_RbmSuggestedAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Intent.Message.RbmSuggestedAction',
          package: const $pb.PackageName(
              const $core.bool.fromEnvironment('protobuf.omit_message_names')
                  ? ''
                  : 'google.cloud.dialogflow.v2beta1'),
        ...
        ..aOM<Intent_Message_RbmSuggestedAction_RbmSuggestedActionDial>(
            3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dial',
            subBuilder:
                Intent_Message_RbmSuggestedAction_RbmSuggestedActionDial.create)
        ..aOM<Intent_Message_RbmSuggestedAction_RbmSuggestedActionOpenUri>(
            4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'openUrl',
            subBuilder: Intent_Message_RbmSuggestedAction_RbmSuggestedActionOpenUri.create)
...
class Intent_Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Intent.Message',
    ...
    ..aOM<$19.Struct>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'payload', subBuilder: $19.Struct.create)
...
class Intent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$5.Context>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputContexts', $pb.PbFieldType.PM, subBuilder: $5.Context.create)
