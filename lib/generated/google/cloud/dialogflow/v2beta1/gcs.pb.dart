...
class GcsSources extends $pb.GeneratedMessage {
  ...
  factory GcsSources.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GcsSources.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  GcsSources copyWith(void Function(GcsSources) updates) =>
      super.copyWith((message) => updates(message as GcsSources))
          as GcsSources; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static GcsSources getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GcsSources>(create);
