...
final $typed_data.Uint8List listKnowledgeBasesResponseDescriptor =
    $convert.base64Decode(
        'ChpMaXN0S25vd2xlZGdlQmFzZXNSZXNwb25zZRJXCg9rbm93bGVkZ2VfYmFzZXMYASADKAsyLi5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52MmJldGExLktub3dsZWRnZUJhc2VSDmtub3dsZWRnZUJhc2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List createKnowledgeBaseRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List updateKnowledgeBaseRequestDescriptor =
    $convert.base64Decode(
        'ChpVcGRhdGVLbm93bGVkZ2VCYXNlUmVxdWVzdBJaCg5rbm93bGVkZ2VfYmFzZRgBIAEoCzIuLmdvb2dsZS5jbG91ZC5kaWFsb2dmbG93LnYyYmV0YTEuS25vd2xlZGdlQmFzZUID4EECUg1rbm93bGVkZ2VCYXNlEkAKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza0ID4EEBUgp1cGRhdGVNYXNr');
