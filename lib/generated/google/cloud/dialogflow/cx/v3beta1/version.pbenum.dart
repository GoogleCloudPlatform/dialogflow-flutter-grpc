...
class Version_State extends $pb.ProtobufEnum {
  static const Version_State STATE_UNSPECIFIED = Version_State._(
      0,
  ...
  static const Version_State RUNNING = Version_State._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'RUNNING');
  static const Version_State SUCCEEDED = Version_State._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SUCCEEDED');
  static const Version_State FAILED = Version_State._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FAILED');
  ...
  static final $core.Map<$core.int, Version_State> _byValue =
