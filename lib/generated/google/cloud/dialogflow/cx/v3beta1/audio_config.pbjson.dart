...
const InputAudioConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.dialogflow.cx.v3beta1.AudioEncoding',
      '8': const {},
      '10': 'audioEncoding'
    },
    const {
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.dialogflow.cx.v3beta1.SpeechModelVariant',
      '10': 'modelVariant'
    },
    const {
      '1': 'single_utterance',
...
final $typed_data.Uint8List inputAudioConfigDescriptor = $convert.base64Decode(
    '');
...
const VoiceSelectionParams$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.dialogflow.cx.v3beta1.SsmlVoiceGender',
      '10': 'ssmlGender'
    },
  ],
};
...
final $typed_data.Uint8List voiceSelectionParamsDescriptor = $convert.base64Decode(
    'ChRWb2ljZVNlbGVjdGlvblBhcmFtcxISCgRuYW1lGAEgASgJUgRuYW1lElQKC3NzbWxfZ2VuZGVyGAIgASgOMjMuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cuY3gudjNiZXRhMS5Tc21sVm9pY2VHZW5kZXJSCnNzbWxHZW5kZXI=');
...
const SynthesizeSpeechConfig$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.dialogflow.cx.v3beta1.VoiceSelectionParams',
      '10': 'voice'
    },
  ],
};
...
final $typed_data.Uint8List synthesizeSpeechConfigDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List outputAudioConfigDescriptor = $convert.base64Decode(
    '');
