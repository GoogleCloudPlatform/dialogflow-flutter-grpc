...
class ConversationTurn_UserInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'isWebhookEnabled')
    ..aOM<$8.QueryInput>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'input',
        subBuilder: $8.QueryInput.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(5)
  $8.QueryInput get input => $_getN(2);
  @$pb.TagNumber(5)
  set input($8.QueryInput v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $8.QueryInput ensureInput() => $_ensure(2);
}
...
class ConversationTurn_VirtualAgentOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$6.Intent>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'triggeredIntent', subBuilder: $6.Intent.create)
  ...
  @$pb.TagNumber(7)
  $6.Intent get triggeredIntent => $_getN(3);
  @$pb.TagNumber(7)
  set triggeredIntent($6.Intent v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $6.Intent ensureTriggeredIntent() => $_ensure(3);
...
class TransitionRouteGroupCoverage_Coverage extends $pb.GeneratedMessage {
  ...
  factory TransitionRouteGroupCoverage_Coverage({
    $9.TransitionRouteGroup? routeGroup,
  ...
  @$pb.TagNumber(1)
  $9.TransitionRouteGroup get routeGroup => $_getN(0);
  @$pb.TagNumber(1)
  set routeGroup($9.TransitionRouteGroup v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $9.TransitionRouteGroup ensureRouteGroup() => $_ensure(0);
